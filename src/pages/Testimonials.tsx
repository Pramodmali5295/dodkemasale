...
const reviews = [
  ...
  { name: "Merin Thomas", location: "Verified Customer", text: "For all the spicy food lovers who want a restaurant like experience at home, Dodke Masala is the answer. Good quality, worth the price", rating: 5 },
